...
describe Xberg do
  describe "batch" do
    ...
    it "extract_batch with invalid bytes MIME type" do
      __result = Xberg.extract_batch(Array(Xberg::ExtractInput).from_json(("[{\"bytes\":[72,101,108,108,111],\"kind\":\"bytes\",\"mime_type\":\"application/x-nonexistent\"}]")), Xberg::ExtractionConfig.from_json("{}"))
      # TODO: unsupported assertion `not_error`
    end
    ...
    it "extract_batch: empty batch" do
      __result = Xberg.extract_batch(Array(Xberg::ExtractInput).from_json(("[]")), Xberg::ExtractionConfig.from_json("{}"))
      # TODO: unsupported assertion `not_error`
      (__result.try(&.results).try(&.size) || 0).should eq(0)
    end
    it "extract_batch with missing URI inputs" do
      __result = Xberg.extract_batch(Array(Xberg::ExtractInput).from_json(("[{\"kind\":\"uri\",\"uri\":\"/nonexistent/a.pdf\"},{\"kind\":\"uri\",\"uri\":\"/nonexistent/b.txt\"}]")), Xberg::ExtractionConfig.from_json("{}"))
      # TODO: unsupported assertion `not_error`
    end
    it "extract_batch over URI inputs" do
      __result = Xberg.extract_batch(Array(Xberg::ExtractInput).from_json(("[{\"kind\":\"uri\",\"uri\":\"pdf/fake_memo.pdf\"},{\"kind\":\"uri\",\"uri\":\"text/fake_text.txt\"}]")), Xberg::ExtractionConfig.from_json("{}"))
      # TODO: unsupported assertion `not_error`
    end
    it "extract_batch with missing URI input" do
      __result = Xberg.extract_batch(Array(Xberg::ExtractInput).from_json(("[{\"kind\":\"uri\",\"uri\":\"/nonexistent/a.pdf\"}]")), Xberg::ExtractionConfig.from_json("{}"))
      # TODO: unsupported assertion `not_error`
    end
    it "extract_batch with mixed valid and missing URI inputs" do
      __result = Xberg.extract_batch(Array(Xberg::ExtractInput).from_json(("[{\"kind\":\"uri\",\"uri\":\"text/plain.txt\"},{\"kind\":\"uri\",\"uri\":\"/nonexistent/missing.pdf\"}]")), Xberg::ExtractionConfig.from_json("{}"))
      # TODO: unsupported assertion `not_error`
    end
  end
end
