...
Extract text, tables, images, metadata, and code intelligence from 101 file formats and 371 programming languages including PDF, Office documents, images, and audio/video transcripts where native transcription is available. Crystal bindings over the C FFI with `#` doc comments, `JSON::Serializable` types, and fiber-based concurrency for streaming.
