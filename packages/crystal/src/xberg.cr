...
module Xberg
  ...
  class ImageMetadataType
    ...
    @[JSON::Field(converter: ImageTypeConverter)]
  ...
  class StructuredData
    ...
    @[JSON::Field(converter: StructuredDataTypeConverter)]
  ...
  class HtmlMetadata
    ...
    @[JSON::Field(converter: TextDirectionConverter)]
  ...
  def self.ensure_initialized() : Nil
    __result = LibXberg.ensure_initialized()
    __code = LibXberg.last_error_code
    if __code != 0
      __ctx_ptr = LibXberg.last_error_context
      raise String.new(__ctx_ptr) unless __ctx_ptr.null?
  ...
  def self.classify_chunks(result : ExtractedDocument, config : ChunkClassificationConfig) : Nil
    ...
    __result = LibXberg.classify_chunks(__handle_result, __handle_config)
    __code = LibXberg.last_error_code
    if __code != 0
      __ctx_ptr = LibXberg.last_error_context
      raise String.new(__ctx_ptr) unless __ctx_ptr.null?
